...
export default function PipelinesPage() {
  ...
  const handleDealMoved = useCallback(
    async (dealId: string, newStageId: string) => {
      ...
      const { error } = await supabase
        ...
        .eq("id", dealId);
      if (error) {
        toast.error(t("pipelines.toast.moveFailed"));
        refreshDeals();
      }
    },
  ...
  async function handleCreatePipeline() {
    ...
    if (error || !pipeline) {
      toast.error(t("pipelines.toast.createFailed"));
      setCreating(false);
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <GatedButton
            ...
            gateReason={t("pipelines.gate.createPipelines")}
          ...
          <GatedButton
            ...
            gateReason={t("pipelines.gate.createDeals")}
      ...
      <Dialog open={newPipelineOpen} onOpenChange={setNewPipelineOpen}>
        <DialogContent className="sm:max-w-sm bg-popover border-border">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">{t("pipelines.newPipeline")}</DialogTitle>
          </DialogHeader>
          <div className="py-2">
